...
<template>
  <div class="flex h-screen">
    <div class="flex flex-col w-full items-center justify-center">
      ...
      <form class="w-1/2" @submit.prevent="handleLogin">
        <div class="mb-12">
          <h1 class="text-red-600 font-black text-2xl text-center">
            Vous devez changer votre mot de passe
          </h1>
          <!-- <div class="mt-2 text-xs text-blue-login-410">
        ...
        <div>
          <InputLabel for="matricule" value="Nouveau mot de passe">
            <span class="text-blue-login-430">*</span>
          </InputLabel>
          <TextInput id="password" show-password="logMessage" placeholder="Mot de passe.."
            :type="showPassword ? 'text' : 'password'" class="mt-1 rounded-lg block w-full"
            v-model="form.new_password" required>
            <button class="mx-2" type="button" @click="showPassword = !showPassword">
              <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-blue-login-410">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
              </svg>
              <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5 text-blue-login-410">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="mt-4">
          ...
          <TextInput id="password" show-password="logMessage" placeholder="Mot de passe.."
            :type="showConfirmePassword ? 'text' : 'password'" class="mt-1 rounded-lg block w-full"
            v-model="form.new_password_confirmation" required>
            <button class="mx-2" type="button" @click="showConfirmePassword = !showConfirmePassword">
        ...
        <InputError v-if="myErrors" class="mt-4" :message="myErrors.new_password[0]" />
        <InputError v-if="form.new_password == '123456'|| form.new_password_confirmation == '123456'" class="mt-4" message="Vous devez changer votre mot de passe" />

        <div class="w-full items-center mt-12" v-if="form.new_password != '123456'&& form.new_password_confirmation != '123456'">
          <PrimaryButton class="w-full py-3 rounded-lgg justify-center"
            :class="{ 'opacity-25': form.processing }" :disabled="submiting">
            <svg v-if="submiting" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
      ...
      <div class="grow-2 flex flex-col justify-end mb-4">
        <label class="text-xs">
    ...
    <!-- <div
      ...
      <div class="grow-3">
        <div class="flex flex-col items-center text-white border rounded-medium px-24 py-6">
          ...
          <a href="https://epal.dz/" class="justify-center font-black text-xl">
            EPAL.DZ
          </a>
        </div>
        <div class="flex flex-col items-center text-white px-24 py-6">
          <a href="/acceuil"><q-btn class="ml-6 mt-8" outline icon="home" color="" label="acceuil"
              @click="acceuil" />
          </a>
        </div>
      </div>
